...
public class ShadowButton extends LinearLayout {
    ...
    public ShadowButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mYOffSet = a.getDimensionPixelSize(R.styleable.ShadowButton_yOffset, DensityUtil.INSTANCE.DP2PX(context, 2.0f));
        mBlurRadius = a.getDimensionPixelSize(R.styleable.ShadowButton_blurRadius, DensityUtil.INSTANCE.DP2PX(context, 6.0f));
        ...
        mTextHeight = DensityUtil.INSTANCE.DP2PX(context, 44f);
        mShapeRadius = DensityUtil.INSTANCE.DP2PX(context, 22f);
