package com.platon.aton.widge.table;
...
public class CustomTabLayout  extends HorizontalScrollView {
    ...
    /**
     * Set the radius to be used for tab indicator
     */
    public void setIndicatorCornerRadius(float radius) {
        tabStrip.setIndicatorCornerRadius(radius);
    }

    /**
     * Set the thickness to be used for tab indicator.
     */
    public void setIndicatorThickness(int thickness) {
        tabStrip.setIndicatorThickness(thickness);
    }

    /**
     * Set the {@link ViewPager2.OnPageChangeCallback}. When using {@link CustomTabLayout} you are
     * required to set any {@link ViewPager2.OnPageChangeCallback} through this method. This is so
     * that the layout can update it's scroll position correctly.
     *
     * @see ViewPager2#(ViewPager2.OnPageChangeCallback)
     */
     ...
     */
    public void setViewPager(ViewPager2 viewPager2, List<String> titleList) {

        RecyclerView.Adapter adapter = viewPager2.getAdapter();

        assert adapter != null;

        assert adapter.getItemCount() == titleList.size();
    ...
    private void populateTabStrip() {
        for (int i = 0; i < titleList.size(); ++i) {
            ...
            final View tabView = (tabProvider == null)
                    ? createDefaultTabView(titleList.get(i))
                    : tabProvider.createTabView(tabStrip, title);
    ...
    public interface TabProvider {
         ...
         */
        View createTabView(ViewGroup container,  String title);
    ...
    private static class SimpleTabProvider implements TabProvider {
        ...
        @Override
        public View createTabView(ViewGroup container,  String title) {
            View tabView = null;
