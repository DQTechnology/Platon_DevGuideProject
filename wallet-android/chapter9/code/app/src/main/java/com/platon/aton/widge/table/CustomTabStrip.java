...
public class CustomTabStrip extends LinearLayout {
    ...
    private CustomTabLayout.TabColorizer customTabColorizer;
    ...
    CustomTabLayout.TabColorizer getTabColorizer() {
    ...
    private void drawDecoration(Canvas canvas) {
        ...
        final CustomTabLayout.TabColorizer tabColorizer = getTabColorizer();
...
//            indicatorRectF.set(left, top, right - padding - padding - padding, bottom);
            indicatorRectF.set(left, top, left + (float) DensityUtil.INSTANCE.DP2PX(getContext(), 20), bottom);
