...
object WalletManager {
     ...
     * 地址钱包名的映射
     */
    private val addressWalletNameMap = HashMap<String, String>()
    ...
    fun LoadAllWallet() {
        ...
        try {
            ...
            file.listFiles()?.forEach {
                ...
                val walletName = it.name.split(".")[0];
                walletSet.add(walletName);

                val address = GetWalletAddress(walletName)

                addressWalletNameMap[address] = walletName;
     ...
     * 通过钱包地址获取钱包名
     */
    fun GetWalletNameByAddress(address: String?): String {
        return addressWalletNameMap[address] ?: return ""
    ...
    fun GetAllWalletAddress(): List<String> {
        return addressWalletNameMap.keys.toList()
    }
    ...
    private fun storePrivateKey(
        ...
        return try {
            ...
            addressWalletNameMap[walletFile.address.mainnet] = walletName
