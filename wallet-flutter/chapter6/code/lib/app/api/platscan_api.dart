...
class PlatScanApi {
  ...
  static Future<RespPage<AliveStakingListResp>> getAliveStakingList(AliveStakingListReq aliveStakingListReq) async {
    HttpClientRequest request = await getHttpClientRequest("/staking/aliveStakingList");
    ...
    if (response.statusCode == HttpStatus.ok) {
      ...
      List<AliveStakingListResp> aliveStakingList = AliveStakingListResp.fromList(jsonMap["data"]);
