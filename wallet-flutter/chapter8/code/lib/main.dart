...
import 'app/page/create_wallet_stateful_widget.dart';
import 'app/page/delegate_detail_stateful_widget.dart';
import 'app/page/import_stateful_widget.dart';
import 'app/page/network_setting_stateful_widget.dart';
...
void _loadWallet() async {
  ...
  await NetworkManager.loadNodeConfig();
    ...
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(
            ...
            page: () {
              return AnnotatedRegion<SystemUiOverlayStyle>(
                  child: const NetworkSettingStatefulWidget(),
                  value: StatusBarUtil.getDarkOverlayStyle());
            }),
        GetPage(
            name: "/createwallet",
